...
sys_cputs(const char *s, size_t len)
{
  ...
  // provjeravamo da li nas proces ima permisije za citanje memorije
  // ako nema onda onda se samo unisti
...
syscall(uint32_t syscallno, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  // syscallno nam je zapravo eax registar i spram njega se odredjuje koji case
  // je u pitanju, a u eax se takodjer i vraca ono sto je odradjeno u case-ovima
  // Prvi je cputs u koji posaljemo edx i ecx od procesa koji smo prekinuli,te 
  // nam on vrati 0
  // Naredni je cgetc, zatim sys_getenvid koji nam vraca id od procesa
  // A zadnji unistava proces koji je bio u toku
  // Sve ostalo je invalidno
}

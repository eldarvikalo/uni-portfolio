...
public:
    ...
    Queue(const Queue &other) : capacity_(other.capacity_), head_(other.head_), tail_(other.tail_), full_(other.full_), buffer_(new T[capacity_])
    {
    ...
    Queue(Queue &&other) : capacity_(other.capacity_), head_(other.head_), tail_(other.tail_), full_(other.full_), buffer_(other.buffer_)
    {

...
public:
  ...
  MojVektor(const std::initializer_list<T> &l) : capacity_(l.size()), size_(l.size()), arr_(new T[capacity_])
  {
    int i = 0;
  ...
  MojVektor(const MojVektor &obj2) : capacity_(obj2.capacity_), size_(obj2.size_), arr_(new T[capacity_])
  {
  ...
  MojVektor &operator=(const MojVektor &obj2)
  {
  ...
  MojVektor(MojVektor &&obj2) : capacity_(obj2.capacity_), size_(obj2.size_), arr_(obj2.arr_)
  {
    obj2.capacity_ = 0;
    obj2.size_ = 0;
    obj2.arr_ = nullptr;
  }
  MojVektor &operator=(MojVektor &&obj2)
  {
    //if(this == &obj2) return *this;
    delete[] arr_;
    capacity_ = obj2.capacity_;
  ...
  bool operator==(const MojVektor &obj2) const
  {
    if (size_ == obj2.size_)
    {
      for (int i = 0; i < size_; i++)

...
void UpisiRadnike(std::ifstream& input, MojVektor<Radnik>& vec)
{ 
...
void IspisRadnika(const MojVektor<Radnik>& vec)
{
...
void Retirement(MojVektor<Radnik>& radnici)
{
  ...
  void Salary_10_percent(MojVektor<Radnik>& radnici)
{
...
void Salary_20_percent(MojVektor<Radnik>& radnici)
{
